#ifndef RS232COMTHREAD_H
#define RS232COMTHREAD_H
...
class RS232ComThread:public QObject
{
    Q_OBJECT
...
public:
    ...
    /*构造函数，传入串口配置ini文件*/
    RS232ComThread(QString configfile,QObject *parent = 0);
